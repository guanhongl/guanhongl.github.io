...
<img class="ui medium right floated rounded image" src="../images/box.jpg">
...
The capstone project provided me with real-world exposure to the vast field of STEM. There were many aspects of STEM involved in this project; science from analyzing concentrations, technology from programming, and engineering from modifying the sensor. It also taught me important time management skills; a year to work on a project is seemingly a long time, but I needed to make constant progress in order to succeed.
